...
\begin{lemma}
    ...
    \begin{proof}
        ...
        \begin{equation}
            k_{\textrm{P3}} = 50, \quad k_{\textrm{I3}} = 50
        \end{equation}
        ...
        \begin{align*}
            a_3 &= 113.55 > 0 \quad \checkmark \\
            a_0 &= 7.66 > 0 \quad \checkmark \\
            b_1 &= 759.68 > 0 \quad \checkmark \\
            c_1 &= 772.90 > 0 \quad \checkmark
        \end{align*}
        
        Adicionalmente, se verificó que la matriz $\bar{A}_2$ con estas ganancias es Hurwitz. 
        Los valores propios de $\bar{A}_2$ son:
        \begin{equation}
            \lambda_1 = -106.41, \quad \lambda_2 = -5.90, \quad \lambda_3 = -1.22, \quad \lambda_4 = -0.01
        \end{equation}
