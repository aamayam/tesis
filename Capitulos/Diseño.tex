...
\begin{equation}
p_2(s) = a_4s^4 + a_3s^3 + a_2s^2 + a_1s + a_0 \label{eq:poly_rh}
\end{equation}

donde:
\begin{align}
a_4 &= 1 \label{eq:a4} \\
a_3 &= 281.69k_{P2} + 103.55 \label{eq:a3} \\
a_2 &= 281.69k_{I2} + 431.76k_{P2}k_{P3} - 0.0015k_{P2} - 0.0004 \label{eq:a2} \\
a_1 &= 431.76k_{I2}k_{P3} - 0.0015k_{I2} + 431.76k_{P2}k_{I3} \label{eq:a1} \\
a_0 &= 431.76k_{I2}k_{I3} \label{eq:a0}
\end{align}
...
\begin{align}
a_4 &> 0 \label{eq:cond0} \\
a_3 &> 0 \label{eq:cond1} \\
a_2 &> 0 \label{eq:cond2} \\
a_1 &> 0 \label{eq:cond3} \\
a_0 &> 0 \label{eq:cond4} \\
...
De donde obtenemos:
\begin{equation}
k_{P3} > 3.48\times10^{-6} \label{eq:kp3_min}
\end{equation}
