...
\begin{itemize}
    \item El coefiente $a_4 = 1$ es constante y positivo.
    \item Para el coeficiente $a_3$ necesitamos que se cumpla:
    \begin{align*}
    ...
    \item Para el coeficiente $a_2$ la condición es:
    \begin{align*}
        & \frac{R\bar{\gamma_1}}{L} + k_{\textrm I2}' + \bar{\gamma_1}k_{\textrm P2}' + \bar{\gamma_2}k_{\textrm P2}'k_{\textrm P3} > 0
        \\ 
        \Longleftrightarrow\;\; & k_{\textrm I2}' > 0; k_{\textrm P2}' > 0; k_{\textrm P3} > 0
    \end{align*}

    \item Para el coeficiente $a_1$ la condición es:
    \begin{align*}
        & \bar{\gamma_1}k_{\textrm I2}' + \bar{\gamma_2}k_{\textrm I2}'k_{\textrm P3} + \bar{\gamma_2}k_{\textrm I3}k_{\textrm P2}' > 0
        \\
        \Longleftrightarrow\;\; & k_{\textrm I2}' > 0; k_{\textrm P2}' > 0; k_{\textrm I3} > 0; k_{\textrm P3} > 0; 
    \end{align*}

    \item Para el coeficiente $a_0$ la condición es:
    \begin{align*}
    ...
    \item Para que se cumpla que $b_1 > 0$ necesitamos:
    \begin{align*}
        b_1 = \frac{a_3a_2 - a_4a_1}{a_3} > 0
    \end{align*}
    Como $a_4 = 1$
    \begin{align*}
        \Rightarrow\;\; & b_1 = \frac{a_3a_2 - a_1}{a_3} = a_2 - \frac{a_1}{a_3} > 0
        \\
        \Rightarrow\;\; & a_2 > \frac{a_1}{a_3}
        \\
        \Rightarrow\;\; & \frac{R\bar{\gamma_1}}{L} + k_{\textrm I2}' + \bar{\gamma_1}k_{\textrm P2}' + \bar{\gamma_2}k_{\textrm P2}'k_{\textrm P3} 
        > \frac{\bar{\gamma_1}k_{\textrm I2}' + \bar{\gamma_2}k_{\textrm I2}'k_{\textrm P3} + \bar{\gamma_2}k_{\textrm I3}k_{\textrm P2}'}{\bar{\gamma_1} + k_{\textrm P2}'}
    \end{align*}

    \item Para que se cumpla que $c_1 > 0$ necesitamos:
    \begin{align*}
        & c_1 = \frac{b_1a_1 - a_3b_2}{b_1} = \frac{b_1a_1 - a_3a_0}{b_1} = a_1 - \frac{a_3a_0}{b_1} > 0
        \\
        \Rightarrow\;\; &a_1 > \frac{a_0a_3}{b_1}
        \\
        \Rightarrow\;\; &\bar{\gamma_1}k_{\textrm I2}' + \bar{\gamma_2}k_{\textrm I2}'k_{\textrm P3} + \bar{\gamma_2}k_{\textrm I3}k_{\textrm P2}'
        > \ldots \\
        \ldots &\frac{\left(\bar{\gamma_2}k_{\textrm I2}'k_{\textrm I3}\right)\left(\frac{R}{L} + \bar{\gamma_1} + k_{\textrm P2}'\right)}{\frac{R\bar{\gamma_1}}{L} + k_{\textrm I2}' + \bar{\gamma_1}k_{\textrm P2}' + \bar{\gamma_2}k_{\textrm P2}'k_{\textrm P3} 
        - \frac{\bar{\gamma_1}k_{\textrm I2}' + \bar{\gamma_2}k_{\textrm I2}'k_{\textrm P3} + \bar{\gamma_2}k_{\textrm I3}k_{\textrm P2}'}{\bar{\gamma_1} + k_{\textrm P2}'}}
    \end{align*}
\end{itemize}
